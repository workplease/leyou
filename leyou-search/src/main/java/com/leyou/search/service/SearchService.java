...
public class SearchService {
    ...
    private List<Map<String, Object>> getParamAggResult(Long cid, QueryBuilder basicQuery) {
        ...
        //添加规格参数的集合
        params.forEach(param ->{
            queryBuilder.addAggregation(AggregationBuilders.terms(param.getName()).field("spaces."+param.getName()+".keyword"));
        });
        ...
        //解析集合结果集，key-集合名称（规格参数名） value-聚合对象
